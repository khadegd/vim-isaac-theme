...
" License:      MIT
" Last Updated: Thursday 31 December 2020 07:38:44 PM IST
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  ...
  hi diffAdded guifg=#4bcb01 guibg=#fafafa guisp=NONE gui=NONE cterm=NONE
  hi diffChanged guifg=#996b14 guibg=#fafafa guisp=NONE gui=NONE cterm=NONE
  hi diffRemoved guifg=#cb1c01 guibg=#fafafa guisp=NONE gui=NONE cterm=NONE
  hi GitGutterAddLineNr guifg=#4bcb01 guibg=#fafafa guisp=NONE gui=NONE cterm=NONE
  hi GitGutterChangeLineNr guifg=#996b14 guibg=#fafafa guisp=NONE gui=NONE cterm=NONE
  hi GitGutterDeleteLineNr guifg=#cb1c01 guibg=#fafafa guisp=NONE gui=NONE cterm=NONE
...
if s:t_Co >= 256
  ...
  hi diffAdded ctermfg=76 ctermbg=231 cterm=NONE
  hi diffChanged ctermfg=94 ctermbg=231 cterm=NONE
  hi diffRemoved ctermfg=160 ctermbg=231 cterm=NONE
  hi GitGutterAddLineNr ctermfg=76 ctermbg=231 cterm=NONE
  hi GitGutterChangeLineNr ctermfg=94 ctermbg=231 cterm=NONE
  hi GitGutterDeleteLineNr ctermfg=160 ctermbg=231 cterm=NONE
...
if s:t_Co >= 8
  ...
  hi diffAdded ctermfg=DarkGreen ctermbg=LightGrey cterm=NONE
  hi diffChanged ctermfg=DarkYellow ctermbg=LightGrey cterm=NONE
  hi diffRemoved ctermfg=DarkRed ctermbg=LightGrey cterm=NONE
  hi GitGutterAddLineNr ctermfg=DarkGreen ctermbg=LightGrey cterm=NONE
  hi GitGutterChangeLineNr ctermfg=DarkYellow ctermbg=LightGrey cterm=NONE
  hi GitGutterDeleteLineNr ctermfg=DarkRed ctermbg=LightGrey cterm=NONE
